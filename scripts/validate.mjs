...
if (pkg.version !== '0.9.0') throw new Error('La versión de package.json no es 0.9.0.');
if (!html.includes('0.9.0')) throw new Error('La versión visible no coincide.');
if (!readme.includes('0.9.0')) throw new Error('README no documenta la versión actual.');
